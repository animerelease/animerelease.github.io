...
# Oldest month the walk will reach; VIZ's English catalogue starts ~2002, and
# BACKFILL_EMPTY_STOP halts the walk anyway once the calendar stops rendering,
# so the floor is a backstop rather than a tuned limit.
BACKFILL_FLOOR = datetime.date.fromisoformat(os.getenv('VIZ_BACKFILL_FLOOR', '2002-01-01'))
